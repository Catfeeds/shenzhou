<?php
/**
 * File: FactoryOrderToSelfSendNotification.class.php
 * User: xieguoqiu
 * Date: 2016/12/27 16:28
 */

namespace Admin\Repositories\Listeners;

use Admin\Model\BaseModel;
use Admin\Repositories\Events\FactoryOrderToSelfEvent;
use Common\Common\Repositories\Events\EventAbstract;
use Common\Common\Repositories\Listeners\ListenerInterface;

class FactoryOrderToSelfSendNotification implements ListenerInterface
{

    /**
     * @param FactoryOrderToSelfEvent $event
     */
    public function handle(EventAbstract $event)
    {
        ...
        $notification = "【厂家处理中】尊敬的用户，您的{$info['servicebrand_desc']}{$info['model']}{$info['servicepro_desc']}的{$servicetype}工单，厂家正在安排处理，请保持电话畅通。";
