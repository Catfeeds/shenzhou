<?php
/**
 * File: ReturnReceiveOrderJob.class.php
 * Function:
 * User: sakura
 * Date: 2018/2/6
 */
...
class ReturnReceiveOrderJob implements Queue
{
    ...
    public function handle()
    {
        ...
        $param = [
            ...
            'receive_role_type' => C('AUTO_RECEIVE_ROLE_TYPE.RETURNEE'),
            'timestamp'         => time(),
        ];
        (new SystemReceiveOrderLogic())->workerOrderReceive($param);
        event(new WorkbenchEvent(['worker_order_id' => $worker_order_id, 'event_type' => C('WORKBENCH_EVENT_TYPE.ADMIN_RETURNEE_RECEIVE')]));
    }
