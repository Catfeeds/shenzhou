...
class FactoryAdmin extends UserCommonInfo
{
    ...
    {
        return [
            'name' => AuthService::getModel() == AuthService::ROLE_FACTORY_ADMIN ? $this->data['nickout']: $this->data['factory_full_name'].'-'.$this->data['nickout'],
    ...
    protected function loadData($id)
    {
        return BaseModel::getInstance('factory_admin')->getOne([
            ...
            'field' => 'factory_admin.id,tell,nickout,factory_adtags.name group_name,factory.group_id,factory_short_name,factory_full_name'
        ]);
    }
