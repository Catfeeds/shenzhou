<?php
/**
 * File: AdminConfigReceiveFactoryGroupModel.class.php
 * Function:
 * User: sakura
 * Date: 2018/3/20
 */
...
class AdminConfigReceiveFactoryGroupModel extends CacheModel
{

    public static function getTableName()
    {
        return 'admin_config_receive_factory_group';
    }

    public static function getAdminIds($group_id)
    {
        $relation_table_name = 'admin';
        $key = self::getRelationCacheKey($group_id, $relation_table_name);
        ...
        $model = BaseModel::getInstance('admin_config_receive_factory_group');
        $opts = [
            'where' => [
                'group_id' => $group_id,
                'admin_id' => ['in', $available_admin_ids],
