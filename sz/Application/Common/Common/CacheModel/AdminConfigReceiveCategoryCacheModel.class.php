<?php
/**
 * File: AdminConfigReceiveCategoryCacheModel.class.php
 * Function:
 * User: sakura
 * Date: 2018/3/2
 */
...
class AdminConfigReceiveCategoryCacheModel extends CacheModel
{

    public static function getTableName()
    {
        return 'admin_config_receive_category';
    }


    public static function getAdminIds($category_id)
    {
        $relation_table_name = 'admin';
        $key = self::getRelationCacheKey($category_id, $relation_table_name);
        ...
        $model = BaseModel::getInstance('admin_config_receive_category');
        $opts = [
            'where' => [
